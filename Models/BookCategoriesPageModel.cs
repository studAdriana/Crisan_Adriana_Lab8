...
namespace Crisan_Adriana_Lab8.Models
{
    public class BookCategoriesPageModell : PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Crisan_Adriana_Lab8Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Crisan_Adriana_Lab8Context context,
